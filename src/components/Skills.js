...
const skillsData = [
  ...
  { name: 'Oracle SQL', percentage: 65, category: 'Database' },
  { name: 'Python', percentage: 70, category: 'Backend' },
  { name: 'C++', percentage: 80, category: 'Backend' },
  { name: 'Java', percentage: 60, category: 'Backend' },
  { name: 'Git', percentage: 75, category: 'Tools' },
  { name: 'GitHub', percentage: 75, category: 'Tools' },
  { name: 'VS Code', percentage: 85, category: 'Tools' },
  { name: 'Visual Studio', percentage: 65, category: 'Tools' },
